...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../Modules/WuKongRTC/WuKongRTC/RTC/framework/WebRTC.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WuKongRTC/WuKongRTC.framework"
